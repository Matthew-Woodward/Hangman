...
var dinos = ["tyrannosaurus", "triceratops", "brontosaurus", "mososaurus", "brachiosaur", "stegosaurus", "plesiosaur", "allosaurus", "velociraptor", "spinosaurus", "albertosaurus", "baryonyx", "apatosaurus", "ankylosaurus", "diplodocus", "deinonychus", "iguanodon", "megalosaurus", "parasaurolopholous", "carnotaurus", "gigantosaurus", "gorgosaurus", "suchomimus", "corythosaurus", "lesothosaurus", "ornithimomimus", "edmontonia", "lambeosaurus", "tarbosaurus", "kentosaurus", "troodon", "hadrosaurid", "mamenchisaurus", "giraffatitan", "compsognathus", "yanchuanosaurus"];
...
function checkForWin() {
	if (dashesArray.indexOf("_") === -1) {
		alert("You got it! The dinosaur is " + currentWord);
		numWins++;
